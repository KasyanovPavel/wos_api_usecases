# Various Web of Science APIs use cases on JavaScript

## Web of Science Expanded API and Journals API:
* [Journal Metrics Tracker](/JavaScript/retrieve_journal_metrics/)
